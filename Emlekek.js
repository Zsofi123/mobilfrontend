...
export default class FetchExample extends React.Component {
  ...
  fetch("http://10.153.225.236:3000/esemeny", {
      method: "POST",
  ...
  componentDidMount(){
    return fetch('http://10.153.225.236:3000/emlek')
    ...
    return(
      <View style={{flex: 1, paddingTop:20}}>
        <FlatList
          ...
          <Image  source={{uri: 'http://10.153.225.236:3000/'+item.emlek_kepek}} style={{width:500,height:250,marginLeft:"auto",marginRight:"auto"}} />  
